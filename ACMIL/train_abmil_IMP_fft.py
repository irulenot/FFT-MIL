...
from architecture_fft.transformer import MHA, ABMIL_fft
from architecture_fft.transMIL import TransMIL
from engine_fft import train_one_epoch, evaluate
from architecture_fft.dsmil import MILNet, FCLayer, BClassifier
from architecture_fft.bmil import probabilistic_MIL_Bayes_spvis
from architecture_fft.clam import CLAM_SB, CLAM_MB
from architecture_fft.ilra import ILRA
...
def get_arguments():
    ...
    parser.add_argument(
        "--seed", type=int, default=36, help="set the random seed to ensure reproducibility"
    )
...
def main():
    ...
    for epoch in range(conf.train_epoch):
        ...
        test_loss_bag, metrics = evaluate(net, criterion, test_loader, device, conf, 'Test', args.quick)
