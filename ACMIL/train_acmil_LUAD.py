...
def get_arguments():
    ...
    parser.add_argument('--config', dest='config', default='config/luad_config.yml',
...
def main():
    ...
    train_data, val_data, test_data = build_HDF5_feat_dataset(os.path.join(conf.data_dir, 'tumor_vs_normal_resnet_features.h5'), conf)
...
def evaluate(net, criterion, data_loader, device, conf, header):
    ...
    for data in data_loader:
        ...
        sub_preds, logits, attn = net(image_patches)
