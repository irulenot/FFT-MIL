...
from utils import *
from wsi_dataloader_3 import C16DatasetV3,C16DatasetV4,dropout_patches, C16DatasetV3_tcga,LUADDataset
...
def main():
    ...
    parser.add_argument('--save_dir', default='results/ilra_luad/', type=str, help='the directory used to save all the output')
    parser.add_argument('--fold', default='0', type=str, help='fold')
    parser.add_argument('--quick', default=False, type=bool)
    parser.add_argument('--fft_path', default='/data/fftmil/LUAD/luad_fft1/', type=str)
    ...
    trainset = LUADDataset(args, 'train')
    testset = LUADDataset(args, 'test')
