...
from utils import *
from wsi_dataloader_3 import C16DatasetV3,C16DatasetV4,dropout_patches, C16DatasetV3_tcga,IMPDataset
...
def main():
    ...
    parser.add_argument('--save_dir', default='results/ilra_imp/', type=str, help='the directory used to save all the output')
