...
from models.classic_attmil_fft import *
from models.dropout import LinearScheduler

from utils import *
from wsi_dataloader_3 import C16DatasetV3,C16DatasetV3_tcga, LUADDataset_fft
...
def train(trainloader, milnet, criterion, optimizer, args):
    ...
    for batch_id, (feats, label, fft) in enumerate(trainloader):
        ...
        optimizer.zero_grad()
        bag_prediction, _ = milnet(bag_feats, fft)
...
def main():
    ...
    parser.add_argument('--save_dir', default='results/abmil_luad_fft/', type=str, help='the directory used to save all the output')
    ...
    # <------------- define MIL network ------------->
    if args.model == "attn":
        milnet = AttnMIL_fft(args.feats_size,args.num_classes,args.drop_p).cuda()
    ...
    for epoch in tqdm(range(1, args.num_epochs + 1)):
        ...
        save_dir = './results/abmil_LUAD_fft_add_lvl1/'
