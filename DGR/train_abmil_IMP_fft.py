...
from utils import *
from wsi_dataloader_3 import C16DatasetV3,C16DatasetV3_tcga,IMPDataset_fft
...
def main():
    ...
    parser.add_argument('--save_dir', default='results/abmil_imp_fft/', type=str, help='the directory used to save all the output')
    ...
    for epoch in tqdm(range(1, args.num_epochs + 1)):
        ...
        save_dir = './results/abmil_IMP_fft_add/'
