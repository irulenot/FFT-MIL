...
from utils import *
from wsi_dataloader_3 import C16DatasetV3,C16DatasetV3_tcga,BRACSDataset
...
def main():
    ...
    parser.add_argument('--save_dir', default='results/abmil_bracs/', type=str, help='the directory used to save all the output')
