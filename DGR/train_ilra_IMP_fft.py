...
from utils import *
from wsi_dataloader_3 import C16DatasetV3,C16DatasetV4,dropout_patches, C16DatasetV3_tcga,IMPDataset_fft
...
def main():
    ...
    parser.add_argument('--save_dir', default='results/ilra_imp_fft/', type=str, help='the directory used to save all the output')
    parser.add_argument('--fold', default='0', type=str, help='fold')
    parser.add_argument('--quick', default=False, type=bool)
    parser.add_argument('--fft_path', default='/data/fftmil/IMP/imp_fft/', type=str)
    ...
    trainset = IMPDataset_fft(args, 'train')
    testset = IMPDataset_fft(args, 'test')
    ...
    for epoch in tqdm(range(1, args.num_epochs + 1)):
        ...
        save_dir = './results/ilra_IMP_fft_add2/'
