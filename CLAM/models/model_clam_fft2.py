...
class clam_fft2(nn.Module):
    ...
    def forward(self, h, fft, label=None, instance_eval=False, return_features=False, attention_only=False):
        ...
        x2 = 3 * ((x2 - min_vals) / (max_vals - min_vals + 1e-8)) - 1.5
